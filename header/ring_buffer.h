 ...
 */
bool init_ringbuf                   (ring_buffer *buf,
                                     size_t cnt,
                                     size_t data_size);
 ...
 */
bool ringbuf_offer                  (ring_buffer *restrict buf,
 ...
 */
bool ringbuf_poll                   (ring_buffer *restrict buf,
                                     void *restrict out);
 ...
 */
const void *ringbuf_peek            (const ring_buffer *buf);
 ...
 */
void ringbuf_foreach                (const ring_buffer *buf,
                                     void (*it)(const void *));
