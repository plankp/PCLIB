 ...
 */
bool hmap_put               (hash_map * restrict const map, void * restrict pair, void ** restrict repl);
 ...
 * @return true if pair was successfully placed in
 */
bool hmap_put_if_absent     (hash_map * restrict const map, void * restrict pair);
 ...
 */
void * hmap_replace         (hash_map * restrict const map, void * restrict pair);
 ...
 */
void * hmap_remove          (hash_map * restrict const map, void * restrict pair);
